...
public class ArrayUtils {
    ...
    public static String[] toPrimitive(String[] arr) {
        if (arr == null) {
            return null;
        }
    ...
    */
    ...
    public static String[][] toStrArray2(String[] lines) {
        String[][] arr2 = new String[lines.length][];
        for (int r = 0; r < lines.length; r++) {
            arr2[r] = toStrArray(lines[r]);
        }
        return arr2;
    }
    ...
    public static String[][] readStrArray2FromFile(String fileName) {
        try {
            return toStrArray2(readLinesFromFile(fileName));
        }
        catch(FileNotFoundException e) {
            return null;
        }
    ...
    public static void writeStrArrayToFile(String fileName, String[] arr, String itemFormat)
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            for (int i = 0; i < arr.length; i++) {
                out.print(arr[i]+itemFormat);
            }
        }
    }
